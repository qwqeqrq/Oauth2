package com.second.controller.HttpClient;
...
public class httpClient {
    public static String sendPostDataByMap(String url, Map<String, String> map, String encoding, String Authorization) throws ClientProtocolException, IOException {
        String result = "";
